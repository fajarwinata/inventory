...
<?php  
	...
	$res = mysql_query($init, $koneksidb) or die ("Gagal Query".mysql_error());
	  ...
	  while ($val = mysql_fetch_array($res)) {
		  ...
		  $init2= mysql_query("SELECT * FROM `barang_inventaris` WHERE status_barang='Rusak' AND kd_barang='$val[kd_barang]'");
	  ...
	  <tr>
		    ...
		    <td id="persen" name="persen">100%<br><!--<button onclick="myFunction(<?php echo $no-1;?>,'<?php echo $kd_barang;?>')" style="font-size: 8pt;">Ubah%</button>--></td>
