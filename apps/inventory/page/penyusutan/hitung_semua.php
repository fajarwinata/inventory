<div class="card-box table-responsive">
  ...
  <tr>
    ...
    <th>Penyusutan<br>Per Bulan</th>

    <th>Akumulasi<br>Penyusutan<br>Tahun 2015</th>
    <th>Nilai Buku<br>Tahun 2015</th>

    <th>Penyusutan<br>Tahun 2016</th>
    <th>Akumulasi<br>Penyusutan<br>Tahun 2016</th>
    <th>Nilai Buku<br>Tahun 2016</th>

    <th>Penyusutan<br>Tahun 2017</th>
    <th>Akumulasi<br>Penyusutan<br>Tahun 2017</th>
    <th>Nilai Buku<br>Tahun 2017</th>

    <th>Penyusutan<br>Tahun 2018</th>
    <th>Akumulasi<br>Penyusutan<br>Tahun 2018</th>
    <th>Nilai Buku<br>Per 31 Des 2018</th>
...
<?php  
	...
	$init= "SELECT * FROM `pengadaan_item` ORDER BY `kd_barang` ASC";
	$res = mysql_query($init, $koneksidb) or die ("Gagal Query".mysql_error());
	  ...
	  <tr>
		    ...
		    <td id="persen" name="persen">25%<br><button onclick="myFunction(<?php echo $no-1;?>,'<?php echo $kd_barang;?>')" style="font-size: 8pt;">Ubah%</button></td>

		    <td><?php echo number_format($penystpertahun, 0, ' ', '.'); ?></td>
		    <td><?php echo number_format($penystperbulan, 0, ' ', '.'); ?></td>

		    <td><?php echo number_format($peny_2015, 0, ' ', '.'); ?></td>
