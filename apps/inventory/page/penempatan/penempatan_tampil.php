...
<thead>
  <tr>
    ...
    <th width="40px" ><strong>No. Penempatan</strong></th>
    <th width="72px" ><strong>Keterangan</strong></th>
    <th width="72px" ><strong>Departemen &amp; Lokasi</strong></th>
  ...
  <tr>
    ...
    <td width="40" align="center"><a href="?open=<?php echo md5('penempatan-hapus')?>&&Kode=<?php echo $noNota; ?>" target="_self"
	onclick="return confirm('ANDA YAKIN AKAN MENGHAPUS DATA PENEMPATAN INI ... ?')" class="btn btn-danger">Hapus</a>
    <a href="cetak/penempatan_cetak.php?noNota=<?php echo $noNota; ?>" target="_blank" class="btn btn-info">Cetak</a></td>
  </tr>
  <?php } ?>
  </tbody>
</table>
